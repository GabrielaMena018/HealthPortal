...
namespace RegistroPacientes.View.Ineventario
{
    public partial class FrmAddInventory : Form
    {
        ...
        {
            InitializeComponent();
            ControllerAddInventory obj = new ControllerAddInventory(this, accion);
        }

        public FrmAddInventory(int accion, int id, string nameMedicment, string categoryMedicment, DateTime expirationDate, string stock, DateTime income, DateTime exit, string description)
        {
            InitializeComponent();
